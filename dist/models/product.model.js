...
const editProductById = (id, data) => __awaiter(void 0, void 0, void 0, function* () {
    var _a, _b;
    const selectProd = yield productsById(id);
    if (!selectProd)
        return null;
    const updateProd = {
        productName: (_a = data.productName) !== null && _a !== void 0 ? _a : selectProd.productName,
        price: (_b = data.price) !== null && _b !== void 0 ? _b : selectProd.price
    };
    return yield prisma.product.update({ where: { id }, data: updateProd });
});
const removeProd = (id) => __awaiter(void 0, void 0, void 0, function* () {
